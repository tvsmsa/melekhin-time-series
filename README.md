...
| ARIMA | 1265.17 | 0.87 | 1613.99 | 0.08 | (order=(4,0,3), seasonal_order=(1, 0, 0)) | ARIMA с ручными параметрами. Использует экзогенные факторы |
...
| AutoARIMA | 1514.53 | 1.04 | 1989.30 | 0.10 | season_length=SEASON | ARIMA с автоматическим подбором параметров. Без экзогенных факторов. |
...
- LASSO, Linear Regression и Ridge все показывают близкие результаты
