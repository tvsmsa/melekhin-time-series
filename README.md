...
| TBATS | Стат. | 1304.56 | 0.89 | 1600.69 | 0.09 |
...
Результаты: лучшей моделью оказалась DL модель LSTM с метриками MAE = 1152.63, RMSE = 0.79, SMAPE = 1459, MASE=0.08. Среди статистических методов лучшая модель MSTL, среди ML - Lasso.
