...
| TBATS | 1507.22 | 1814.89 | 0.104 | 1.030 | PH | PH |
...
| ARIMA (без экзогенных факторов) | 1608.02 | 1930.45 | 0.111 | 1.099 | (order=(4,0,3), seasonal_order=(1, 0, 0)) | ARIMA с ручными параметрами |
| ARIMA с экзогенными 
